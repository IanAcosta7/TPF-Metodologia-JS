  ...
  static loadMap(countries) {
    am4core.ready(async function () {
      ...
      polygonSeries.events.on("inited", function () {
        polygonSeries.mapPolygons.each(function (mapPolygon) {
          ...
          if (count > 0) {
            ...
            polygon.multiPolygon = am4maps.getCircle(mapPolygon.visualLongitude, mapPolygon.visualLatitude, Math.max(0.5, Math.log(count) * Math.LN10 / 20));
      ...
      countries.forEach(country => {
        if (country.abbreviation != undefined) {
            data[country.abbreviation] = country.confirmed
        }
      });
